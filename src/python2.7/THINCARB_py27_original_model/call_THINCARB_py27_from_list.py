...
# (c)2015 S. King
#
# Example of how to run THINCARB_py27.py using input values stored in Python lists
...
from THINCARB_py27 import MainRoutine
...
for row in range(0,len(inputD)):
	...
	F=inputF[row]
	G=inputG[row]
	MainRoutine(fileout,targetvalue,tolerance,Z,A,B,C,D,E,F,G)
