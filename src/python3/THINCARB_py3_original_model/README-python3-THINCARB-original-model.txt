...
This is the Python 3.x.x source code for an implementation of the original Neal et al (1998) Lotus 1-2-3 macro (see [1]). This spreadsheet also extends the calculations to provide Total Dissolved Inorganic Carbon (DIC) concentrations, and provides for a site (ie, location/station) field to aid the interpretation of large datasets. To all intents and purposes this file is a Pythonic version of the spreadsheet THINCARB-excel2010.xlsm. This file is provided for reference purposes only. It can be opened and read using any ASCII-compatible text editor. Do not edit this file. Edit one of the call handler routines instead.
