...
# (c)2015 S. King
#
# Example of how to run THINCARB_py3.py using input values stored in an external SPACE-DELIMITED file
...
from THINCARB_py3 import MainRoutine
...
# Whatever happens MainRoutine must be called with values for fileout, targetvalue, tolerance, A, B, C, D, E, F and G!
	MainRoutine(fileout,targetvalue,tolerance,SITE,A,B,C,D,E,F,G)
	numrows=numrows+1
